...
description: >
  ...
  search, international patents, and large-scale patent analytics.
...
| Research | `research_search.py` | Google's AI-extracted top terms |
...
- **1-5 GB**: Warning logged, runs automatically
