...
| `google_patents_research.publications` | Google's AI analysis: machine translations, similar documents, extracted top terms | Finding similar patents, translated abstracts |
...
| "What patents are similar to US-11234567?" | `google_patents_research.publications` | Google's similarity data |
...
WHERE
  claim_text LIKE '%blockchain%'
  AND claim_text LIKE '%authentication%'
LIMIT 20
```
