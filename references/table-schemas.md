...
| `similar_documents` | RECORD(REPEATED) | `.publication_number`, `.application_number` |
...
| Table | Key columns |
|---|---|
| `uspto_oce_assignment.assignments` | `patent_id`, `ee_name`, `or_name`, `convey_text`, `recorded_date` |
